// second attempt - Less code but not readable
function myReplace(str, before, after) {

        after = (before.charAt(0) === before.charAt(0).toUpperCase()) !== (after.charAt(0) === after.charAt(0).toUpperCase())
            ? (after.charAt(0) === after.charAt(0).toUpperCase()
                ? after.charAt(0).toLowerCase() : after.charAt(0).toUpperCase()) + after.slice(1) : after;
